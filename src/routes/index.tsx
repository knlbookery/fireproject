...
function Hero({ slides: SLIDES }: { slides: HeroSlide[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-[1400px] flex-col justify-start px-6 pb-32 pt-52 text-white sm:justify-end sm:pt-56 lg:px-10 lg:pb-40 lg:pt-56">
        <div className="max-w-2xl mt-12 sm:mt-16 lg:mt-0">
