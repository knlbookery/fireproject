...
function Hero({ slides: SLIDES }: { slides: HeroSlide[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-[1400px] flex-col justify-end px-6 pb-20 pt-52 text-white sm:pb-24 sm:pt-56 lg:px-10 lg:pb-40 lg:pt-56">
