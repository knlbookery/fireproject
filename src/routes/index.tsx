...
function WorkIndex() {
  ...
  return (
    <section className="bg-pale-blue px-6 py-24 text-ink lg:px-10 lg:py-36">
      <div className={SHELL}>
        <div className="grid gap-8 border-t border-ink/10 pt-10 lg:grid-cols-[1.4fr_1fr] lg:items-end">
          ...
          <p className="measure text-base leading-relaxed text-ink/65 lg:pb-2">
            ...
            {PROGRAMS.map((p, i) => (
              <li key={p.slug}>
                <Link
                  ...
                  className="group flex items-baseline gap-6 border-b border-ink/10 py-7 transition-colors hover:bg-ink/[0.04] focus:outline-none focus-visible:ring-2 focus-visible:ring-ink lg:py-9"
                >
