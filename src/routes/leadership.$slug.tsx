...
function LeaderPage() {
  ...
  return (
    <SiteLayout>
      <section className="bg-surface px-6 pb-16 pt-36 text-ink lg:px-10 lg:pb-20 lg:pt-44">
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="mt-8 flex flex-col items-start gap-8 md:flex-row md:items-center">
            <img
              ...
              className="h-40 w-40 shrink-0 rounded-full object-cover ring-4 ring-ink/10"
              loading="eager"
            />
            <div>
