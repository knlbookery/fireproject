...
export function Footer() {
  return (
    <footer className="w-full bg-sky px-6 pb-10 pt-16 text-ink lg:px-10 lg:pt-20">
          ...
          <div>
            ...
            <div className="mt-6 space-y-2 text-sm text-ink/70">
              <a
                ...
                className="flex items-center gap-2 hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
              >
                ...
                <ul className="mt-4 space-y-2.5 text-sm">
                  {col.links.map((l) => (
                    <li key={l.to}>
                      <Link
                        to={l.to}
                        className="text-ink/70 transition-colors hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                      >
                        {l.label}
                      </Link>
                    </li>
