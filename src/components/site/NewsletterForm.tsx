...
export function NewsletterForm() {
  ...
  if (state === "done") {
    return (
      <div className="flex items-center gap-3 rounded-2xl border border-ink/15 bg-background/70 px-5 py-6 text-sm text-ink/85">
    ...
    <form onSubmit={onSubmit} className="w-full" noValidate>
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <input
          ...
          className="w-full rounded-full border border-ink/15 bg-background px-5 py-3 text-sm text-ink placeholder:text-ink/45 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        />
        <input
          type="text"
          tabIndex={-1}
